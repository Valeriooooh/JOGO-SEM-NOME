...
switch(global.vida){
  case 4: draw_sprite(spr_vida,0,60,40);
  case 3: draw_sprite(spr_vida,1,60,40);
  case 2: draw_sprite(spr_vida,2,60,40);  
  case 1: draw_sprite(spr_vida,3,60,40);
  case 0: draw_sprite(spr_vida,4,60,40);
}
/*if global.vida = 4 {
